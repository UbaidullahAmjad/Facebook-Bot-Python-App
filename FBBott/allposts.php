        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <input type="text" name="time" class=" form-control" required placeholder="Set Time Intervel">
              </div>
              <div class="col-md-2 offset-md-6 mt-3 mb-3">
              <input type="submit" name="posts" value="Buy&Sell" class="btn btn-primary">
              <input type="submit" name="others" value="Other" class="btn btn-primary">
              </div>
              </div>
              </form>
              <?php
                if(isset($_POST['posts'])){
                  $time=$_POST['time'];
                  $del=mysqli_query($con,"delete from settimes");
                  if($del){
                    $inser=mysqli_query($con,"insert into settimes values ('$time')");
                    if($inser){
                      $output1=exec("F:\\python\\fbBot\\temp.py");
                    }
                  }
                ...
                if(isset($_POST['others'])){
                  ...
                  if($del){
                    $inser=mysqli_query($con,"insert into settimes values ('$time')");
                    if($inser){
                      $output1=exec("F:\\python\\fbBot\\otherposts.py");
                    }
                  }
