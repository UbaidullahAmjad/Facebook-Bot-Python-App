...
if(isset($_POST['savepost'])){
  ...
  if(isset($_FILES['image'])){
    ...
    $insert=mysqli_query($con,"insert into posts values (null,'$name','$description','$price','$imagefolder',0)");
    if($insert){
      $posterror="Post Saved";
    }else{
      $posterror="Post Not Saved";
    }
              ...
              <form role="form" method="POST" enctype=multipart/form-data>
                <div class="card-body">
                   ...
                   <div class="form-group">
                    ...
                    <input type="text" required class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter Item Name">
                  </div>
                      <!-- textarea -->
                      <div class="form-group">
                        <label>Description</label>
                        <textarea class="form-control" required name="description" rows="3" placeholder="Enter ..."></textarea>
                      </div>
                      <div class="form-group">
                        <label>Price</label>
                        <input class="form-control" required name="price" rows="3" placeholder="Enter ...">
                      </div>
                  ...
                  <button type="submit" name="savepost" class="btn btn-primary">Submit</button>
                </div></div>
                    </div>
                    <!-- /.card-body -->
              </form>
