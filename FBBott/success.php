...
<body>
  ...
  <p class="lead"></p>
  <hr class="my-4">
  <h2>You'r posts had been succesfully upload to your facebook groups</h2>
  <p class="lead">
    <form class="mt-5" method="POST">
   
    <a  class="btn btn-primary btn-lg" href="allposts.php" role="button"> Go back to posts pages</a>
    </form>
  </p>
</div>
            </div>
